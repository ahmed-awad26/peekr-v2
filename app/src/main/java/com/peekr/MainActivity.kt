...
fun PeekrRoot(securityManager: SecurityManager) {
    ...
    val bottomNavItems = listOf(
        Triple(Screen.Feed.route,     "الرئيسية",  Icons.Default.Home),
        Triple(Screen.Archive.route,  "الأرشيف",   Icons.Default.Bookmarks),
        Triple(Screen.Tools.route,    "الأدوات",   Icons.Default.Extension),
        Triple(Screen.Settings.route, "الإعدادات", Icons.Default.Settings),
    )
